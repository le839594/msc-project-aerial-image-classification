...
def model_training(train_ds, val_ds, model):
  ...
  mcp_save = ModelCheckpoint('.mdl_wts_baseline_test.hdf5', save_best_only=True, monitor='val_accuracy', mode='max')
...
def main():
  ...
  model_evaluation(val_ds, model, ".mdl_wts_baseline_test.hdf5")
  save_model(model, "model_baseline_test")
